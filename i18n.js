...
(() => {
  ...
  const messages = {
    en: {
      ...
      "vote.keyboardHint":
        "Tip: press <kbd>←</kbd> for the left song, <kbd>→</kbd> for the right, <kbd>Space</kbd> to skip.",
      ...
      "leaderboard.hintDefault":
        "Drag any song to any rank — ratings update to match the new order.",
      ...
      "leaderboard.hintVotesMet":
        "{votes} vote(s) cast (recommended {target}). Keep voting to refine, or drag rows to adjust manually.",
      "leaderboard.hintVotesProgress":
        "{songs} songs in pool — {votes} / {target} recommended votes ({remaining} to go). Drag rows to adjust manually anytime.",
      ...
      "leaderboard.dragReorder": "Drag to reorder",
      "leaderboard.dragSong": "Drag to reorder {title}",
      ...
      "about.step3Text":
        "<strong>Leaderboard</strong> shows your ranked songs — or switch to <strong>Albums</strong>. Drag rows to adjust the order manually.",
    ...
    "zh-CN": {
      ...
      "vote.keyboardHint":
        "提示：按 <kbd>←</kbd> 选左侧，<kbd>→</kbd> 选右侧，<kbd>Space</kbd> 跳过。",
      ...
      "leaderboard.hintDefault": "拖动任意歌曲到目标排名 — 评分会自动更新。",
      "leaderboard.hintAlbumsEmpty":
        "专辑排行仅统计在「歌曲」页归入专辑的曲目，未归专辑的单曲不计入。",
      "leaderboard.hintAlbumsCount":
        "共 {albums} 张专辑，来自 {tracks} 首已分组曲目（不含未归专辑的单曲）。",
      "leaderboard.hintVotesMet":
        "已投 {votes} 票（推荐 {target} 票）。可继续投票细化排名，或拖动行手动调整。",
      "leaderboard.hintVotesProgress":
        "曲库 {songs} 首 — 已投 {votes} / {target} 票（还差 {remaining} 票）。可随时拖动行手动调整。",
      ...
      "leaderboard.dragReorder": "拖动排序",
      "leaderboard.dragSong": "拖动以排序 {title}",
      ...
      "about.step3Text":
        "<strong>排行榜</strong>显示歌曲排名，也可切换到<strong>专辑</strong>。拖动行可手动调整顺序。",
